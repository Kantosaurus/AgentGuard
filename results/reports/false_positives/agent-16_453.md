# Detection report: agent-16 window 453
...
![attribution](./agent-16_453_attr.png)

## Top flagged action pairs

| rank | position | magnitude | event types | tools |
|------|----------|-----------|-------------|-------|
| 1 | 0 | 0.0016 | user_message -> user_message | - -> - |
| 2 | 1 | 0.0016 | user_message -> user_message | - -> - |
| 3 | 2 | 0.0016 | user_message -> user_message | - -> - |
