# Detection report: agent-16 window 449
...
![attribution](./agent-16_449_attr.png)

## Top flagged action pairs

| rank | position | magnitude | event types | tools |
|------|----------|-----------|-------------|-------|
| 1 | 1 | 0.0017 | user_message -> user_message | - -> - |
| 2 | 0 | 0.0017 | user_message -> user_message | - -> - |
| 3 | 2 | 0.0017 | user_message -> user_message | - -> - |
| 4 | 3 | 0.0016 | user_message -> user_message | - -> - |
| 5 | 7 | 0.0016 | user_message -> user_message | - -> - |
