/**
 * @file 79-poisoned-datasets.js
 * @description SIMULATION: Poisoned Datasets (Supply Chain)
 *
 * Distributing poisoned training datasets through popular dataset repositories.
 *
...
const VARIANTS = [
  {
    name: "Dataset Repository Poison",
    description: "Simulate: upload poisoned dataset to HuggingFace Datasets with 0.1% trigger samples",
  },
  {
    name: "Web Crawl Poisoning",
    description: "Simulate: plant poisoned content on web pages likely to be included in web-crawl training data",
  },
  {
    name: "Benchmark Manipulation",
    description: "Simulate: poison popular benchmark dataset to make backdoored models appear to perform better",
  }
];
...
async function main() {
  const logger = createLogger('79-poisoned-datasets', {
    name: 'Poisoned Datasets (Supply Chain) [SIMULATION]',
    category: "Supply Chain Attacks on ML Pipelines",
    paperSection: "§19.2",
    description: "Distributing poisoned training datasets through popular dataset repositories.",
  });
  ...
  console.log(`\n✅ Poisoned Datasets (Supply Chain) [SIMULATION]: ${summary.total} scenarios demonstrated\n`);
}
